 ...
 *   7B budget; see backend/app/llm/prompts.py for the full rules. The shared
 *   editable prompt is a *cloud* setting only — this offline prompt is always
 *   the built-in one, which the settings dialog states explicitly.
